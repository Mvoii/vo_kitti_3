...
def visualize_paths(gt_path, pred_path, html_tile="", title="VO exercises", file_out="plot.html"):
    ...
    fig1.circle("gtx", "gty", size=5, source=source, color="blue", hover_fill_color="firebrick", legend_label="GT")
    fig1.line("gtx", "gty", source=source, color="blue", legend_label="GT")

    fig1.circle("px", "py", size=5, source=source, color="green", hover_fill_color="firebrick", legend_label="Pred")
    ...
    fig2.circle("diffx", "diffy", size=5, source=source, hover_fill_color="firebrick", legend_label="Error")
